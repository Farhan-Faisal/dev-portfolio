...
var deleteOne_1 = require("../../vectors/deleteOne");
...
var setupDeleteResponse = function (response, isSuccess) {
    ...
    var VOA = { deleteVectors: fakeDelete };
    var VectorProvider = {
...
describe('deleteOne', function () {
    test('Calls the openapi delete endpoint, passing target namespace and the vector id to delete', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, VectorProvider, VOA, deleteOneFn, returned;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = (0, exports.setupDeleteSuccess)(undefined), VectorProvider = _a.VectorProvider, VOA = _a.VOA;
                    deleteOneFn = (0, deleteOne_1.deleteOne)(VectorProvider, 'namespace');
    ...
    test('Throw error if pass empty string as ID', function () { return __awaiter(void 0, void 0, void 0, function () {
        var VectorProvider, deleteOneFn, toThrow;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    VectorProvider = (0, exports.setupDeleteSuccess)(undefined).VectorProvider;
                    deleteOneFn = (0, deleteOne_1.deleteOne)(VectorProvider, 'namespace');
