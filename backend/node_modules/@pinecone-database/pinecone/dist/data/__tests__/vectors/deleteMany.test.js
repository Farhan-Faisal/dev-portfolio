...
var deleteMany_1 = require("../../vectors/deleteMany");
...
describe('deleteMany', function () {
    test('calls the openapi delete endpoint, passing ids with target namespace', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, VectorProvider, VOA, deleteManyFn, returned;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = (0, deleteOne_test_1.setupDeleteSuccess)(undefined), VectorProvider = _a.VectorProvider, VOA = _a.VOA;
                    deleteManyFn = (0, deleteMany_1.deleteMany)(VectorProvider, 'namespace');
    ...
    test('calls the openapi delete endpoint, passing filter with target namespace', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, VOA, VectorProvider, deleteManyFn, returned;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = (0, deleteOne_test_1.setupDeleteSuccess)(undefined), VOA = _a.VOA, VectorProvider = _a.VectorProvider;
                    deleteManyFn = (0, deleteMany_1.deleteMany)(VectorProvider, 'namespace');
    ...
    test('throws if pass in empty filter obj', function () { return __awaiter(void 0, void 0, void 0, function () {
        var VectorProvider, deleteManyFn, toThrow;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    VectorProvider = (0, deleteOne_test_1.setupDeleteSuccess)(undefined).VectorProvider;
                    deleteManyFn = (0, deleteMany_1.deleteMany)(VectorProvider, 'namespace');
