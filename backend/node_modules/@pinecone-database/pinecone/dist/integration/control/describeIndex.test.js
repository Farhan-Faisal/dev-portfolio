...
describe('describe index; serverless', function () {
    test('describe index, happy path', function () { return __awaiter(void 0, void 0, void 0, function () {
        var description;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    expect((_a = description.spec.serverless) === null || _a === void 0 ? void 0 : _a.cloud).toEqual('aws');
                    expect((_b = description.spec.serverless) === null || _b === void 0 ? void 0 : _b.region).toEqual('us-west-2');
